...
- **Container isolation** - Agents sandboxed in Docker containers (macOS/Linux/Windows)
...
Single Node.js process. Agents execute in isolated Docker containers with mounted directories. Per-group message queue with concurrency control. IPC via filesystem.
...
Docker provides cross-platform support (macOS, Linux, and Windows), a large ecosystem, and mature tooling. Docker Desktop uses a lightweight Linux VM on macOS and Windows.

**Can I run this on Linux or Windows?**

Yes. NanoClaw uses Docker, which works on macOS, Linux, and Windows. Just install Docker and run `/setup`.
