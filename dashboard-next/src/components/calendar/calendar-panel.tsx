...
export function CalendarPanel({
  ...
  return (
    <div
      ref={panelRef}
      className="fixed md:absolute top-14 md:top-[calc(100%+4px)] left-2 right-2 md:left-auto md:right-0 z-20 md:w-[400px] max-h-[calc(100vh-80px)] bg-surface-1 border border-surface-border shadow-2xl overflow-hidden flex flex-col animate-slide-down"
    >
      {/* Header */}
